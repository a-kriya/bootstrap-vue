<template>
  <b-navbar tag="header" type="dark" class="bd-navbar flex-column flex-md-row">
    ...
    <b-navbar-nav class="flex-row ml-md-auto d-none d-md-flex">
      <b-nav-item-dropdown :text="dropdownText" toggle-class="mr-md-2" right>
      ...
      >
        ...
        >
          ...
          <g fill="currentColor">
            <path
              d="M13.1,13.424a1.782,1.782,0,0,0,0,3.552A1.7,1.7,0,0,0,14.736,15.2,1.694,1.694,0,0,0,13.1,13.424Zm5.84,0A1.782,1.782,0,1,0,20.576,15.2,1.7,1.7,0,0,0,18.944,13.424Z"
            />
            <path
